...
*/
const displayNames = [];
zooAnimals.forEach(v => displayNames.push({animal_name: v.animal_name, scientific_name: v.scientific_name}))
...
const lowCaseAnimalNames = zooAnimals.map(v => v.animal_name.toLowerCase())
...
*/
const lowPopulationAnimals = zooAnimals.filter(v => v.population < 5)
...
*/
let populationTotal = zooAnimals.reduce((c,v) => v.population + c,0)
